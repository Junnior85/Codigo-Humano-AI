...
# --- 4. FUNCIÓN "COLADOR" (ESTA ES LA QUE ARREGLA EL PROBLEMA) ---
def generar_respuestas(chat_completion):
    """
    Esta función toma la respuesta sucia de la IA y extrae solo las palabras.
    """
    ...
    if menu == "💬 Chat":
        ...
        if prompt:
            ...
            with st.chat_message("assistant", avatar="🧠"):
                ...
                # Pasamos los datos por el "Colador" para obtener texto limpio
